...
file_in_all = '/home/nknyazeva/courseWork5/data/result/pn_ps/pn_ps_file_name_align.txt'
...
with open(file_in_all, 'r') as in_file:
    list_pn_ps = []
    for line in in_file:
        file_in = line.strip()
        file_out = line.strip()[:-6] + '_pn_ps.txt'
        list_pn_ps.append(main())

with open('/home/nknyazeva/courseWork5/data/result/all_pn_ps_align.txt', 'w') as out_file:
    for line in list_pn_ps:
        if line != None:
            out_file.write(line + '\n')
