...
dir_sh = '/mnt/lustre/nknyazeva/courseWork5/scripts/vcf_to_fasta_GRCh38/'
...
ref_human = '/mnt/lustre/nknyazeva/courseWork5/data/homo_sapiens_GRCh38/reference/GRCh38.fa'
...
vcf_file_human = '/mnt/lustre/nknyazeva/courseWork5/data/homo_sapiens_GRCh38/snp/ALL_wo_Y.vcf.gz'
